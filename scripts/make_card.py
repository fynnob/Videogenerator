...
def download_font(url, filename):
    if not os.path.exists(filename):
        ...
        # GitHub requires a User-Agent header or it might reject the request
...
def generate_card():
    # 🔧 FIX: Updated URLs to include the '/static/' folder where the TTFs live now
    font_bold_url = "https://github.com/google/fonts/raw/main/ofl/roboto/static/Roboto-Bold.ttf"
    font_reg_url = "https://github.com/google/fonts/raw/main/ofl/roboto/static/Roboto-Regular.ttf"
    
    download_font(font_bold_url, "Roboto-Bold.ttf")
    download_font(font_reg_url, "Roboto-Regular.ttf")
    ...
    # Wrap title (using 'title' key as fallback)
    ...
    draw.text((text_x, avatar_y + 38), "u/bot • 5h", fill="#818384", font=font_user)
